      ...
      <tbody>
        <tr>
          <th style={{backgroundColor: "rgba(0, 0, 0, 0.10)", cursor: "pointer"}}>
            <h3 style={{color:"blue"}}className="ui center aligned header" onClick={sortTransactionList} title="click to sort by date">Date</h3>
          </th>
          <th style={{backgroundColor: "rgba(0, 0, 0, 0.10)", cursor: "pointer"}}>
            <h3 style={{color:"blue"}}className="ui center aligned header" onClick={sortTransactionList} title="click to sort by description">Description</h3>
          </th>
          <th style={{backgroundColor: "rgba(0, 0, 0, 0.10)", cursor: "pointer"}}>
            <h3 style={{color:"blue"}}className="ui center aligned header" onClick={sortTransactionList} title="click to sort by category">Category</h3>
          </th>
          <th style={{backgroundColor: "rgba(0, 0, 0, 0.10)", cursor: "pointer"}}>
            <h3 style={{color:"blue"}}className="ui center aligned header" onClick={sortTransactionList} title="click to sort by amount">Amount</h3>
          </th>
          <th style={{backgroundColor: "rgba(0, 0, 0, 0.10)", cursor: "pointer"}}>
            <h3 style={{color:"blue"}} className="ui center aligned header" title="click to sort by amount">Action</h3>
          </th>
        </tr>
        {transactionList}
      </tbody>
